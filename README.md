...
> **他の資格試験にも使えます**: 仕組みは「問題・選択肢・解説を入力して、繰り返し解いて、苦手を見える化する」というだけの汎用的なものなので、社会福祉士以外の資格試験の過去問にもそのまま流用できます。ただし、科目プルダウンの選択肢や新旧カリキュラムの区分、AI 解説依頼文の文言など、一部は社会福祉士向けになっています。
